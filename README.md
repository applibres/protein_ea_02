...
## ./protmut_run.sh test04 sea pdbfile=protein01.pdb,partners=A_C,ligand_chain=C gen=5,popsize=5,random_mutation=0 fitness_idxs=2,3 fitness_weights=-1,1 checkpoint=False checks=2 mobj=True randomseed=15
